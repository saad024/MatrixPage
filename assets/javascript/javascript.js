...
$(document).on("click", function(event){
    ...
    if($trigger !== event.target && !$trigger.has(event.target).length){
        $(".drop2").slideUp("fast");
        // $(".dropdownonelipsis1").hide();
    }
});

$('.elipsisshow2').click( function(){
    console.log("wesal");
    $(".dropdownonelipsis2").toggle();
})
$('.elipsisshow3').click( function(){
    console.log("wesal");
    $(".dropdownonelipsis3").toggle();
})
$('.elipsisshow4').click( function(){
    console.log("wesal");
    $(".dropdownonelipsis4").toggle();
})
$('.elipsisshow5').click( function(){
    console.log("wesal");
    $(".dropdownonelipsis5").toggle();
})
$('.elipsisshow6').click( function(){
    console.log("wesal");
    $(".dropdownonelipsis6").toggle();
})
$('.elipsisshow1').click( function(){
    console.log("wesal");
    $(".dropdownonelipsis1").toggle();
})
$('.elipsisshow7').click( function(){
    console.log("wesal");
    $(".dropdownonelipsis7").toggle();
})
